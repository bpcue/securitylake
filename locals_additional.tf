...
locals {
  ...
  ou_inventory_objects_arn     = local.ou_inventory_prefix_clean != "" ? "arn:aws:s3:::${var.ou_inventory_bucket}/${local.ou_inventory_prefix_clean}/*" : "arn:aws:s3:::${var.ou_inventory_bucket}/*"
